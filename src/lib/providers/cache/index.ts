...
import { env } from '../../env';
import { timingProvider } from '../../utils';
...
export async function getCache(
  ctx: RequestContext,
  hash: string,
): Promise<[number | undefined, Readable | ReadableStream, string | undefined] | null> {
...
export function getGithubProvider(tracker: Tracker): TProvider {
  return {
    name: 'github',
